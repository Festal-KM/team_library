...
const PurchaseRequestPage = () => {
  ...
  const fetchAmazonInfo = async () => {
    ...
    try {
      ...
      setErrorMessage('Amazon情報の取得中にエラーが発生しました');
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMessage('購入申請の送信中にエラーが発生しました');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {amazonInfo && (
        <div className="mb-6 bg-gray-50 p-4 rounded border">
          <h3 className="font-medium mb-2">Amazon情報</h3>
          <div className="flex gap-4">
            ...
            <div>
              <p><span className="font-medium">価格:</span> ¥{amazonInfo.price.toLocaleString()}</p>
